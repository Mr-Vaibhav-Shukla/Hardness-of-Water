...
/*NOTE: This program is valid for some limited salts but can be made for every type of salt by simply extending the data of salts which is initialised first in the program*/
#include<stdio.h>

int main()
{
	printf("*************************************************************************WELCOME*************************************************************************\n");
	printf("**************************************************Here you will calculate the HARDNESS OF WATER**********************************************************\n\n");	//welcome message
	int salt_id[13];
	for(int i=0;i<13;i++)
	{
